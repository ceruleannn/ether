...
<div class="banner-top">
    <div class="container">
        <h1>Register</h1>
        <em></em>
        <h2><a href="index.html">Home</a><label>/</label><a>Register</a></h2>
    </div>
</div>
<!--login-->
<div class="container">
    <div class="login">
        <form id="form">
            <div class="col-md-6 login-do">
                ...
                <div class="login-mail">
                    <input id="realname" type="text" placeholder="真实名字">
                    <i class="glyphicon glyphicon-user"></i>
                </div>
                ...
                <div class="login-mail">
                    <input id="mail" type="text" placeholder="邮箱">
                    <i class="glyphicon glyphicon-user"></i>
                </div>
...
<script src="../../ui/js/shop.register.js"></script>
